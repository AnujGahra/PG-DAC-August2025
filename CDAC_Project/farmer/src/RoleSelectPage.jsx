...
const RoleSelectPage = ({ onSelectRole }) => {
  return (
    <div className="ac-page">
      ...
      <div className="ac-card">
        ...
        <button
          className="ac-role ac-role-farmer"
          onClick={() => onSelectRole("farmer")}
        >
          <div className="ac-role-icon ac-role-icon-farmer">
        ...
        <button
          className="ac-role ac-role-admin"
          onClick={() => onSelectRole("admin")}
        >
          <div className="ac-role-icon ac-role-icon-admin">
